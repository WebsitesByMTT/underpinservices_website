...
export default function ServicesHexagon() {
  ...
  return (
    <section className="h-screen z-50 bg-white shadow-[0px_-59px_55px_2px_rgb(255,255,255)] flex items-center justify-center md:p-4">
        ...
        {services.map((service) => (
          ...
          >
            ...
            >
              ...
              <span className="text-[.81rem] md:text-sm tracking-wide lg:text-base xl:text-lg font-medium text-secondary">
                {service.name}
              </span>
            </div>
          </div>
