    ...
    return (
        <section className="flex flex-col scroll-smooth">
            <div className=" sticky top-0 h-screen w-full flex items-center justify-center">
                <h2 className="text-[5.3125rem] text-center tracking-tight text-secondary leading-[7.0125rem]">
                    <span className="font-switzer font-semibold">
                        Pinning Your Vision
                    </span>
                    <span className="block text-primary font-sweetSuckerPunch text-[7.1875rem] font-normal leading-[9.580625rem]">To Reality</span>
                </h2>
            </div>
            <div className="h-screen w-full flex items-center justify-center z-10 bg-white shadow-[0px_-59px_55px_2px_rgb(255,255,255)]" >
                <div className="relative">
                    <Logo className="w-[22.735rem] h-[42.582rem]" />
...
const Tag = ({ name, className }: { name: string, className?: string }) => {
    return (
        <div className={`bg-[#D9D9D9] font-switzer text-[1.5rem] font-normal leading-[1.98rem] text-secondary py-3 px-4 flex items-center justify-center gap-4 absolute ${className}`}>
