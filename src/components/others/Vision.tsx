        ...
        <section className="flex  flex-col scroll-smooth">
            ...
            <div className="lg:h-screen w-full scale-75 flex items-center justify-center z-10 bg-white shadow-[0px_-59px_55px_2px_rgb(255,255,255)]" >
                <div className="relative">
                    ...
                    <Tag name="Search Engine Optimization (SEO)" className="top-[7%] right-[20%] lg:right-[70%] -rotate-[6.12deg]" />
                    <Tag name="Game Development" className="top-[40%] lg:top-[30%] right-[65%] lg:right-[95%] rotate-[0.43deg]" />
                    <Tag name="Social Media Marketing" className="top-[75%] lg:top-[50%] right-[70%] lg:right-[80%] -rotate-[5.68deg]" />

                    <Tag name="Web Development" className="top-[35%] left-[50%] lg:top-[7%] lg:left-[75%] rotate-[5.93deg]" />
                    <Tag name="Content Marketing (Script Writing)" className="top-[60%] lg:top-[28%] left-[40%] lg:left-[92%] -rotate-[5.35deg]" />
                    <Tag name="Pay Per Click (PPC)" className="top-[100%] lg:top-[51%] left-[50%] lg:left-[75%] rotate-[3.21deg]" />
                </div>
            </div>
        </section>
    )
...
const Tag = ({ name, className }: { name: string, className?: string }) => {
    return (
        <div className={`bg-[#D9D9D9] font-switzer text-secondary py-2 px-4 flex items-center justify-center  gap-2 absolute ${className}`} style={{ fontSize: 'clamp(0.75rem, 1.5vw, 1.5rem)', lineHeight: '1.3' }}>
            ...
            <h6 className="w-[170px] lg:text-nowrap lg:w-[400px]">
                {name}
            </h6>
        </div>
    )
